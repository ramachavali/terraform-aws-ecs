...
resource "aws_ecs_service" "ecs_service" {
    name                                = "${random_string.string.id}-ecs-service"
...
# This block registers the tasks to a target group of the loadbalancer.
  load_balancer {
    ...
    container_name                      = "${random_string.string.id}-container"
